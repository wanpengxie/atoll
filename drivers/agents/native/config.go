...
func DefaultConfig() json.RawMessage {
	return json.RawMessage(`{"loopers":["agent-looper"],"llm_actor":"pi-llm","max_open_works":32,"max_assignments_per_looper":32,"max_inputs_per_work":128,"max_operation_keys":256,"max_turns":12,"tool_result_max_lines":2000,"tool_result_max_bytes":51200,"tool_image_max_bytes":3145728,"compact":{"context_window":128000,"reserve_tokens":16384,"keep_recent_tokens":20000},"archive":{"keep_alive":3,"idle_ms":3600000}}`)
}

func ParseConfig(raw json.RawMessage) (Config, error) {
	cfg := Config{Loopers: []string{"agent-looper"}, LLMActor: "pi-llm", MaxOpenWorks: 32, MaxAssignmentsPerLooper: 32, MaxInputsPerWork: 128, MaxOperationKeys: 256, MaxTurns: 12, ToolResultMaxLines: 2000, ToolResultMaxBytes: 50 << 10, ToolImageMaxBytes: 3 << 20}
...
const ConfigSchema = `{"type":"object","additionalProperties":false,"properties":{"loopers":{"type":"array","minItems":1,"items":{"type":"string","minLength":1}},"llm_actor":{"type":"string","minLength":1},"model":{"type":"string"},"models":{"type":"array","items":{"type":"string","minLength":1}},"default_model":{"type":"string"},"default_thinking_level":{"type":"string"},"compact":{"type":"object","properties":{"context_window":{"type":"integer","minimum":4096},"reserve_tokens":{"type":"integer","minimum":0},"keep_recent_tokens":{"type":"integer","minimum":1},"model":{"type":"string"}},"additionalProperties":false},"archive":{"type":"object","properties":{"keep_alive":{"type":"integer","minimum":0},"idle_ms":{"type":"integer","minimum":0}},"additionalProperties":false},"max_open_works":{"type":"integer","minimum":1,"maximum":10000},"max_assignments_per_looper":{"type":"integer","minimum":1,"maximum":10000},"max_inputs_per_work":{"type":"integer","minimum":1,"maximum":10000},"max_operation_keys":{"type":"integer","minimum":1,"maximum":10000},"tool_timeout_ms":{"type":"integer","minimum":1,"maximum":1800000},"execution_timeout_ms":{"type":"integer","minimum":1,"maximum":86400000},"max_turns":{"type":"integer","minimum":1,"maximum":128},"tool_result_max_lines":{"type":"integer","minimum":1,"maximum":100000},"tool_result_max_bytes":{"type":"integer","minimum":1024,"maximum":4194304},"tool_image_max_bytes":{"type":"integer","minimum":1024,"maximum":3145728}}}`
