...
func ParseConfig(raw json.RawMessage, workspace string, logger *slog.Logger) (Config, error) {
	...
	return Config{WorkspaceDir: workspace, Binary: "claude", Model: spec.Model, Logger: logger, processFactory: spawnProcess, versionProbe: probeVersion, latestProbe: probeLatestClaude, Selections: selections, SelectionTitles: titles, Default: spec.Default, Prompt: spec.Prompt}, nil
}
