...
// here; per-frame-type payloads live in the sibling viewsync and placement
// packages, plus framework/devicetransit for generic device relay payloads.
package daemonbus
...
const (
	// View-sync frames (also exposed via viewsync.FrameType — keep
	...
	FrameTypeDeviceTransitLifecycle FrameType = "device_transit.lifecycle"
)
...
// type-specific struct (viewsync.PushFrame, placement.CreateChannelRequest,
// etc.) without forcing daemonbus to
