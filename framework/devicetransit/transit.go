...
// RuntimeEventKindDeviceLifecycle is the adapter.RuntimeEvent kind used
// when a device bridge lifecycle frame is routed into an adapter module.
const RuntimeEventKindDeviceLifecycle adapter.RuntimeEventKind = "device_lifecycle"
...
// EncodeLifecycleRuntimeEventPayload encodes a lifecycle frame as the opaque
// adapter.RuntimeEvent payload.
func EncodeLifecycleRuntimeEventPayload(frame LifecycleFrame) (json.RawMessage, error) {
...
// DecodeLifecycleRuntimeEventPayload decodes an opaque adapter.RuntimeEvent
// payload into a lifecycle frame.
func DecodeLifecycleRuntimeEventPayload(payload json.RawMessage) (LifecycleFrame, error) {
