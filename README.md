...
> **v0.02 — pre-release, not data-safe.** Storage formats, APIs and the wire
...
```bash
ATOLL_VERSION=v0.02 ...               # pin a release instead of taking the latest
...
**v0.02, pre-release.** The core (identity, channels, ledger, membership, devices,
