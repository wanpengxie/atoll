...
> **v0.03 — pre-release, not data-safe.** Storage formats, APIs and the wire
...
```bash
ATOLL_VERSION=v0.03 ...               # pin a release instead of taking the latest
...
**v0.03, pre-release.** The core (identity, channels, ledger, membership, devices,
