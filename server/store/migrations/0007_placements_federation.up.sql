...
-- columns on channel_placements per launch-ticket notes §T10.
--
-- All three columns are nullable; launch demo flows leave them NULL.
...
-- are not active in launch so an index would only add write cost without
