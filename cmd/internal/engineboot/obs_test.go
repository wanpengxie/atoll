...
func TestProductionAdaptersSixObservationWordsHaveCompleteGoldenJSON(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			golden: `{"subject":"space/decls","kind":"decls","complete":true,"items":[{"key":"5d3fb46c-2d36-57d3-a324-66628dfd67c8","declared":{"id":"5d3fb46c-2d36-57d3-a324-66628dfd67c8","name":"steward","description":"The node owner's own agent.","owner":"root","default_class":"codex","config":{},"status":"present","visibility":"private","created_at":1700000000000,"updated_at":1700000000000},"actual":null},{"key":"c0.lobby","declared":{"id":"c0.lobby","name":"c0.lobby","description":"Handle for the registration lobby.","owner":"root","default_class":"peeractor","config":{"channel":"c0.lobby"},"status":"present","visibility":"public","created_at":1700000000000,"updated_at":1700000000000},"actual":null},{"key":"registrar","declared":{"id":"registrar","name":"registrar","description":"Channel registry seat.","owner":"root","default_class":"registrar","config":{},"status":"present","visibility":"private","created_at":1700000000000,"updated_at":1700000000000},"actual":null},{"key":"svcactor","declared":{"id":"svcactor","name":"svcactor","description":"Channel service face.","owner":"root","default_class":"svcactor","config":{},"status":"present","visibility":"private","created_at":1700000000000,"updated_at":1700000000000},"actual":null}]}`,
		},
		{
