...
// mechanism: it folds opaque snapshots and never interprets them (it enforces
// structure, not vocabulary — online/offline is the consumer's read via
// introspect.ParseDevicePresence).
