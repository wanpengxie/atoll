...
// eight capabilities the design fixes: View / Spawn / Remove / ServeAttach /
// Subscribe / CancelRequest / KickDaemon / Close. Gate is GONE under sealed-pen —
...
func TestHomePublicSurface(t *testing.T) {
	want := []string{"CancelRequest", "Close", "KickDaemon", "Remove", "ServeAttach", "Spawn", "Subscribe", "View"}
