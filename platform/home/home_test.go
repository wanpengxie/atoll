...
func openTestHome(t *testing.T) *home.Home {
	...
	h, err := home.Open(home.Config{CompositionResolver: emptyCompositionResolver{}, DaemonAuthority: allowTestDaemonAuthority{}, ChannelID: testChannelID, DBPath: dbPath, Bootstrap: true})
	if err != nil {
		t.Fatalf("Open: %v", err)
	}
...
func TestOpen_RestartOverPersistentDB(t *testing.T) {
	dbPath := filepath.Join(t.TempDir(), "home.sqlite")
	h1, err := home.Open(home.Config{CompositionResolver: emptyCompositionResolver{}, DaemonAuthority: allowTestDaemonAuthority{}, ChannelID: testChannelID, DBPath: dbPath, Bootstrap: true})
	if err != nil {
	...
	h2, err := home.Open(home.Config{CompositionResolver: emptyCompositionResolver{}, DaemonAuthority: allowTestDaemonAuthority{}, ChannelID: testChannelID, DBPath: dbPath, MustExistDB: true})
	if err != nil {
