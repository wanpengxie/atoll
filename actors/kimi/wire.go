...
// adapter's PRIVATE language with one Kimi WebBridge browser extension —
// deliberately NOT the channel envelope and NOT any legacy device_transit frame
// family. Two frames, paired by correlation_id:
//
