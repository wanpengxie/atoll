...
// needs no locks. One adapterActor per adapter; there is NO long-lived
// god-object and this package must not reintroduce one.
//
...
// type catalog is a domain concern outside this package.
//
...
// non-actor callers that block-await off the cell goroutine; an adapter cell
// calling out emits a request + handles the
